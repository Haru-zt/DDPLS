...
# 20% coco train2017 is set as labeled dataset
labeled_dataset = _base_.labeled_dataset
labeled_dataset.ann_file = 'train_20_labeled/annfiles'
labeled_dataset.data_prefix = dict(img_path='train_20_labeled/images/')

unlabeled_dataset = _base_.unlabeled_dataset
unlabeled_dataset.ann_file = 'train_20_unlabeled/empty_annfiles/'
unlabeled_dataset.data_prefix = dict(img_path='train_20_unlabeled/images/')
...
visualizer = dict(
    type='RotLocalVisualizer', vis_backends=vis_backends, name='visualizer', save_dir='work_dirs/ddpls_2xb3-180000k_semi-0.2-dotav1.5')