...
# 100% coco train2017 is set as labeled dataset
labeled_dataset = _base_.labeled_dataset
labeled_dataset.ann_file = 'train/annfiles'
labeled_dataset.data_prefix = dict(img_path='train/images/')

unlabeled_dataset = _base_.unlabeled_dataset
unlabeled_dataset.ann_file = 'test/annfiles/'
unlabeled_dataset.data_prefix = dict(img_path='test/images/')
...
visualizer = dict(
    type='RotLocalVisualizer', vis_backends=vis_backends, name='visualizer', save_dir='work_dirs/ddpls_2xb3-180000k_semi-full-dotav1.5')