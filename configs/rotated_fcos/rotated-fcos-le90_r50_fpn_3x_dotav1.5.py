...
train_cfg = dict(
    type='IterBasedTrainLoop', max_iters=96000, val_interval=3200)
...
visualizer = dict(
    type='RotLocalVisualizer', vis_backends=vis_backends, name='visualizer', save_dir='work_dirs/rotated-fcos-le90_r50_fpn_3x_dotav1.5')