_base_ = [
    '../_base_/datasets/dotav15_5per.py',
...
visualizer = dict(
    type='RotLocalVisualizer', vis_backends=vis_backends, name='visualizer', save_dir='work_dirs/rotated-fcos-le90_r50_fpn_3x_dotav1.5_5per')
